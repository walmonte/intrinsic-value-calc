...
class ApiFunction(Enum):
    """Enum representing different API functions for fetching stock data from Alpha Vantage."""
    ...
    def get_url(self):
        """Returns the URL for the API function, formatted with the symbol placeholder."""
        return BASE_URL.format(self.value[0], "{}")

    def get_url_name(self):
        """Returns the name of the API function used in the URL."""
        return self.value[0]

    def get_json_name(self):
        """Returns the name of the API function used in the JSON response."""
        return self.value[1]
